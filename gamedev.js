$( document ).ready(function() {
	...
	$("#goRight1").click(function() {
		$("#exploreBody").css("background-image", "url('rm1.jpg')");
		$("#goRight1").hide();
		$("#goBack").hide();
	...
	$("#goLeft1").click(function() {
		$("#exploreBody").css("background-image", "url('rm6.jpg')");
		$("#goLeft1").hide();
		$("#goLeft2").show();
	});
